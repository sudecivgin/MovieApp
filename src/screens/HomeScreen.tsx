...
const categories = ['All', 'Comedy', 'Animation', 'Documentary'];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} style={styles.carousel}>
          ...
          <Image source={avatar1} style={styles.featuredImage} />
          <Text style={styles.featuredTitle}>Avatar</Text>
        ...
        <View style={styles.carouselItem}>
          <Image source={batman} style={styles.featuredImage} />
          <Text style={styles.featuredTitle}>Batman</Text>
          <Text style={styles.featuredDate}>On March 2, 2022</Text>
        </View>


        <View style={styles.carouselItem}>
          <Image source={mid} style={styles.featuredImage} />
          <Text style={styles.featuredTitle}>Midsommar</Text>
          <Text style={styles.featuredDate}>On March 2, 2022</Text>
        </View>
        ...
        <View style={styles.carouselItem}>
          <Image source={wakanda} style={styles.featuredImage} />
          <Text style={styles.featuredTitle}>Black Panther: Wakanda Forever</Text>
          <Text style={styles.featuredDate}>On March 2, 2022</Text>
        </View>
